...
export default function SplashPage({ onEnter }: { onEnter: () => void }) {
  const tags = [
  ...
  return (
    <div className="flex-1 flex flex-col relative z-0">
      ...
      <div className="absolute top-[-100px] left-[-100px] w-64 h-64 bg-primary/20 rounded-full blur-[100px] z-[-1]" />
      <div className="absolute bottom-[-100px] right-[-100px] w-80 h-80 bg-secondary/10 rounded-full blur-[120px] z-[-1]" />
      ...
      <motion.div 
        ...
        className="px-6 pb-10 mt-auto w-full"
      >
